...
export function CommentForm({ onSubmit, isSubmitting, initialRating = 5, placeholder = "Share your experience..." }) {
  ...
  useEffect(() => {
    async function checkToxicity() {
      ...
      try {
        ...
        // Error is handled gracefully if toxicity check fails
      } finally {
        setIsChecking(false)
      }
    }
